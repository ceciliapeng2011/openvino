...
namespace ngraph
{
    namespace runtime
    {
        namespace reference
        {
            ...
            {               
                auto num_selected = std::accumulate(valid_outputs.begin(), valid_outputs.end(), decltype(valid_outputs)::value_type(0));
                ...
                /* data */
                size_t selected_outputs_size = selected_outputs.size();
